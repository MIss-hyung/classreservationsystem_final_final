...
<script>
	var idcheck;
	function IdCheckedClose(adminid) {
		opener.document.joinformAdmin.id.value = adminid;
		window.opener.getreturn();
		window.close();
		opener.document.joinformAdmin.adminpassword.focus();
	}
</script>
</head>
<body>
	<!--  submit 실행 시 IdChecked.jsp로 되돌아 간다. -->
	<form method="post" action="IdCheckedadmin.jsp">
